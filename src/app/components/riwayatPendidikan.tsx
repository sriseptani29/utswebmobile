  ...
  return (
    <div className="border border-[hsl(45,100%,97%)] rounded-lg bg-[hsl(50,100%,90%)] dark:bg-[hsl(25,35%,25%)] shadow hover:bg-[hsl(30,100%,85%)] dark:hover:bg-[hsl(20,50%,35%)] transition my-3">
      <div className="container mx-auto">
        <div className="grid grid-cols-12 text-md mb-3 text-center text-gray-800 dark:text-gray-100">
...
export default function RiwayatPendidikan() {
  return (
    <section className="riwayatpendidikan bg-white dark:bg-gray-800 py-8">
      <div className="container mx-auto p-4 text-center pt-10">
        <h2 className="text-2xl font-bold mb-6 text-center text-gray-800 dark:text-white">Riwayat Pendidikan</h2>
